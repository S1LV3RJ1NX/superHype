...
Operating manual for `backend/`. Read this and `docs/ARCHITECTURE.md` before writing code. `docs/ARCHITECTURE.md` is the authoritative reference for structure, data model, roles, auth, connections, and the publishing pipeline, and reflects the code as written.
