...
Operating manual for `backend/`. Read this and `docs/BACKEND.md` before writing code. `docs/DESIGN.md` is the system overview; `docs/BACKEND.md` is the authoritative backend spec and wins on structure, roles, auth, and connections.
